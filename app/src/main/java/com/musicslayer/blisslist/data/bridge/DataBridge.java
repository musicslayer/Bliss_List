...
public class DataBridge {
    ...
    public interface ExportableToJSON {
        void exportDataToJSON(Writer o) throws IOException;
        void importDataFromJSON(Reader o) throws IOException;
    }

    public interface ReferenceableToJSON {
        void referenceToJSON(Writer o) throws IOException;
    ...
    private static class ByteSerializableToJSON implements SerializableToJSON {
        ...
        public static byte deserializeFromJSON(Reader o) throws IOException {
    ...
    private static class IntegerSerializableToJSON implements SerializableToJSON {
        ...
        public static int deserializeFromJSON(Reader o) throws IOException {
    ...
    private static class LongSerializableToJSON implements SerializableToJSON {
        ...
        public static long deserializeFromJSON(Reader o) throws IOException {
    ...
    private static class DateSerializableToJSON implements SerializableToJSON {
        ...
        public static Date deserializeFromJSON(Reader o) throws IOException {
    ...
    private static class BigDecimalSerializableToJSON implements SerializableToJSON {
        ...
        public static BigDecimal deserializeFromJSON(Reader o) throws IOException {
    ...
    private static class FileSerializableToJSON implements SerializableToJSON {
        ...
        public static File deserializeFromJSON(Reader o) throws IOException {
    ...
    private static class DocumentFileSerializableToJSON implements SerializableToJSON {
        ...
        public static DocumentFile deserializeFromJSON(Reader o) throws IOException {
            o.beginObject();
